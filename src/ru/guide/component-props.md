...
:::warning ВНИМАНИЕ
Обратите внимание, что объекты и массивы в JavaScript передаются по ссылке, поэтому если входной параметр массив или объект, то изменения внутри дочернего компонента этого объекта или массива **будет влиять** на состояние родителя, а Vue не в состоянии предупредить об этом. Как правило, следует избегать мутаций любых входных параметров, включая объекты и массивы, так как это игнорирует одностороннее связывание данных и может привести к нежелательным результатам.
:::

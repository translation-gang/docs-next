...
Опасности идентификации встречаются редко. Однако чтобы безопасно использовать API `markRaw` и shallowXXX, нужно твёрдо понимать, как работает система реактивности.
:::

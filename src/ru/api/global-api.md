...
Можно передавать любое количество объектов, при этом приоритет будет у свойств, идущих позднее. Слушатели событий будут обработаны специальным образом, как `class` или `style`: значения этих свойств объединяются, а не перезаписываются.

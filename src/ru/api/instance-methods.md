...
- **Опция: flush**
  ...
  Дополнительную информацию об опции `flush` можно изучить в разделе [синхронизации времени очистки эффектов](../guide/reactivity-computed-watchers.md#синхронизация-времени-очистки-эффектов).
